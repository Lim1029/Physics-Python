...
x_0 = 3
x_1 = 0 
print("Bisect Method, x =", bisec(x_0,x_1))
print("Newton Method, x =", newton(x_0))
...
ax3.plot(x_real,y_real, color="blue")
ax3.plot(x_real,np.zeros(100), color="blue")
